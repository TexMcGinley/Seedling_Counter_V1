...
def match_descriptors(desc1, desc2, ratio=0.8, max_keep=200):
    if desc1 is None or desc2 is None:
        return []

    print("Matching descriptors (KNN + ratio test).")
    ...
    good = good[:max_keep]
    print(f"Retained {len(good)} good matches after ratio test.")
    return good
